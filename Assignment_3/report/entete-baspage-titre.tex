...
\usepackage[pdftitle={Assignement 3},  % apparition ds les propriétés du doc
...
% Police
   %\textsl{•}\renewcommand\familydefault{ptm}        % famille normale: Times ptm
...
% En-tete
    \lhead{\texttt{LINGI2132} - Assignement 3 - Languages and translators }        \chead{}        \rhead{Baufays - Colmonts}
...
% Bas de page
    ...
    \lfoot{Partie \rightmark}        \cfoot{}        \rfoot{Page \thepage~$-$~3}
