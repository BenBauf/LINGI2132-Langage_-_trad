...
class JavaCCParser implements JavaCCParserConstants {
  ...
  final private JForInitStatement forInitStatement() throws ParseException {
        int line = 0;
        JForInitStatement init;
        JStatement stmnt = null;
    ArrayList<JStatement> stmnts = null;
    stmnt = statementExpression();
      line = token.beginLine; stmnts = new ArrayList<JStatement>(); stmnts.add(stmnt);
    label_7:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case COMMA:
      ...
      init = new JForInitStatement(line, stmnts);
      {if (true) return init;}
    throw new Error("Missing return statement in function");
  }

  final private JForInitVarDeclaration forInitVarDeclaration() throws ParseException {
        int line = 0;
    JForInitVarDeclaration init = null;
    JVariableDeclaration decl = null;
    ArrayList<JVariableDeclarator> decls  = null;
    ArrayList<String> mods = null;
    Type type = null;
    ...
    default:
     ...
     line = token.beginLine;
    type = type();
    decls = variableDeclarators(type);
      decl = new JVariableDeclaration(line, mods, decls); init = new JForInitVarDeclaration(line, decl);
      {if (true) return init;}
    throw new Error("Missing return statement in function");
  }
  ...
  final private ArrayList<JStatement> forUpdate() throws ParseException {
    int line = 0;
    ArrayList<JStatement> stmnts = null;
    JStatement aStmnt = null;
    try {
      aStmnt = statementExpression();
          line = token.beginLine; stmnts = new ArrayList<JStatement>(); stmnts.add(aStmnt);
      label_8:
      while (true) {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case COMMA:
  ...
  final private JStatement statement() throws ParseException {
    ...
    JForInitExpression forInit = null;
    ...
    try {
      ...
      case FOR:
        ...
        if (jj_2_6(2147483647)) {
          ...
          body = statement();
                      statement = new JEnhancedForStatement(line, param, expr, body) ;
        } else {
          switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
          case BOOLEAN:
          case CHAR:
  ...
  final private JExpression conditionalExpression() throws ParseException {
    int line = 0;
    JExpression testE = null, thenE = null, elseE = null;
    try {
      testE = conditionalAndExpression();
                                             line = testE.line();
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case QUESTION_MARK:
        jj_consume_token(QUESTION_MARK);
        thenE = assignmentExpression();
        jj_consume_token(COLON);
        elseE = conditionalExpression();
              testE = new JConditionalExpression( line, testE, thenE, elseE );
        break;
      default:
        jj_la1[40] = jj_gen;
        ;
  ...
  static {
   ...
   private static void jj_la1_0() {
      jj_la1_0 = new int[] {0x800000,0x40000,0x27002400,0x0,0x27000400,0x27000400,0x8000,0x27101c00,0x101800,0x0,0x101800,0xd0731800,0xd0630000,0x0,0x8000000,0x0,0xc0610000,0xc8711800,0xc0610000,0xc0610000,0xc8711800,0xc0610000,0xd0630000,0x0,0x101800,0x0,0x0,0xc0610000,0x0,0xc0610000,0x0,0xc0610000,0x101800,0x101800,0x0,0x0,0x101800,0x0,0x0,0x0,0x0,0x0,0x80000,0x80000,0x0,0x0,0x0,0xc0610000,0x0,0xc0610000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xc0610000,0x101800,0x0,0x101800,0x0,0x410000,};
   }
   private static void jj_la1_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x0,0x1000000,0x0,0x0,0x0,0x8000002,0x8000002,0x440000,0x8000000,0x8845320d,0x8845320d,0x800000,0x0,0x800000,0x88013201,0x88013201,0x88013201,0x88013201,0x88413201,0x88013201,0x8845320d,0x800000,0x8000000,0x800000,0x20,0x88053201,0x800000,0x88053201,0x800000,0x88013201,0x0,0x0,0x100000,0x100000,0x8000000,0x4020,0x4020,0x400,0x2000000,0x80,0x900,0x900,0x2010,0x2010,0x8000,0x88013201,0x1000,0x88010001,0x1100000,0x40,0x10000,0x1100000,0x10000,0x10000,0x1010000,0x10000,0x88010001,0x8000000,0x40000,0x8000000,0x100000,0x80000001,};
   }
   private static void jj_la1_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x3,0x3,0x0,0x0,0x0,0x3,0x3,0x3,0x3,0x3,0x3,0x3,0x0,0x0,0x0,0x0,0x3,0x0,0x3,0x0,0x3,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x3,0x0,0x3,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x3,0x0,0x0,0x0,0x0,0x3,};
   }
